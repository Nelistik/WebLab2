  ...
  Демонстрацию работы можно увидеть в [отчёте](https://github.com/adam-p/markdown-here)отчёте/номерных файлах "task№". Все функции вместе находятся в файле "allFunctionsTogether(1to5).py"
