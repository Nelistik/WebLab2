  ...
  Демонстрацию работы можно увидеть в [отчёте](https://github.com/adam-p/markdown-here) и номерных файлах. Все функции вместе находятся в соответствующем файле.
